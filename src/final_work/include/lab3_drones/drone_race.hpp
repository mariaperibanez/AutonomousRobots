...
private:
    ...
    // Update the gates with noise, draw them and generate a new trajectory
    void updateGateObservations_();
    void gateUpdateTimerCallback_(const ros::TimerEvent&);
};
